...
Для отправки данных на удаленный репозиторий, необходимо создать его на github
после этого ввести команду из предложенных **git remote add origin https://github.com/irb1z/unit.git** тем самым соединив наш репозиторий с облачным.
Дальше ввести команду **git push -u origin master** 
наши файлы отправятся на удаленный репозиторий.
